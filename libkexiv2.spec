...
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/libkexiv2-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/libkexiv2-20.08.3.tar.xz.sig
...
%prep
%setup -q -n libkexiv2-20.08.3
cd %{_builddir}/libkexiv2-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604614654
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkexiv2-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/libkexiv2/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/libkexiv2-20.08.3/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libkexiv2/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/libkexiv2-20.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkexiv2/c08668a6ace9b36ba46940609040748161b03a37
pushd clr-build
%make_install
popd

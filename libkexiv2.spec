...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/libkexiv2-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/libkexiv2-24.02.0.tar.xz.sig
...
%prep
%setup -q -n libkexiv2-24.02.0
cd %{_builddir}/libkexiv2-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709243512
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5KExiv2.so.5.1.0
/usr/lib64/libKF5KExiv2.so.15.0.0
/usr/lib64/libKF5KExiv2.so.5.1.0

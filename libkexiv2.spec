...
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/libkexiv2-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/libkexiv2-21.08.2.tar.xz.sig
...
%prep
%setup -q -n libkexiv2-21.08.2
cd %{_builddir}/libkexiv2-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634327881
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkexiv2-21.08.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/libkexiv2/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/libkexiv2-21.08.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkexiv2/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd

...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/libkexiv2-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/libkexiv2-25.04.0.tar.xz.sig
...
%setup -q -n libkexiv2-25.04.0
cd %{_builddir}/libkexiv2-25.04.0
pushd ..
cp -a libkexiv2-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744908136
mkdir -p clr-build
pushd clr-build

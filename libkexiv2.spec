...
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/libkexiv2-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/libkexiv2-24.02.2.tar.xz.sig
...
%prep
%setup -q -n libkexiv2-24.02.2
cd %{_builddir}/libkexiv2-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712861547
mkdir -p clr-build
pushd clr-build
